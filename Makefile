...
LDFLAGS=-ldflags="-s -w -X main.gitCommit=$(GIT_COMMIT) -X main.mainVersion=$(MAIN_VERSION)"
...
windows:
	...
	GOOS=windows GOARCH=amd64 go build -o $(RELEASE_DIR)/windows/foset_windows.exe $(LDFLAGS) *.go
